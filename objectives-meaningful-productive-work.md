...
![https://cdn.gobeyond.so/misc/blog/objective-1.png](https://cdn.gobeyond.so/misc/blog/objective-1.png)
...
In the words of [the great Ira Glass](https://www.youtube.com/watch?v=dx2cI-2FJRs&t=1m37s), "*it’s time to kill. And it’s time to enjoy the killing. Because by killing, you will make something else even better live."*
...
![https://cdn.gobeyond.so/misc/blog/objective-2.png](https://cdn.gobeyond.so/misc/blog/objective-2.png)
...
1. Set objectives together. Ask yourself *"what is most important right now?"* and then refine it by questioning that statement together.
2. Question everything you do by asking *"how does this bring us one step closer to our objective?"* Kill or pause any planned work that doesn't help.
3. Objectives should never be prescriptive. Remember that by giving trust to our diverse and inclusive teams, we create a more successful and happy environment.
4. Objectives are the starting point for all team work. Each team should use their unique skills and domain to contribute to reaching the objective.
