{
  ...
  "date": "2021-05-17T14:00:10.951Z",
  "title": "Running Continuous Product Discovery in Startups",
  "description": "Every startup should run product discovery in an integrated setup and continuously. I will use real-world examples from Beyond to explain why and share potential discovery techniques you can include in your daily work.",
  "image": "https://cdn.gobeyond.so/misc/blog/continuous-product-discovery.jpg"
}
---
In startups, our biggest challenge is to reach product-market fit, and therefore we talk to many users to understand their problems and needs as explained in more detail in a previous [article](https://beyond.so/blog/understanding-our-first-1000-users). Talking to users is an integral part of running product discovery but only one possible method of gaining new information.

Every startup should run product discovery in an integrated setup and continuously. I will use real-world examples from Beyond to explain why and share potential discovery techniques you can include in your daily work. If product discovery as a topic is new to you, feel free to watch [this talk from minute 8 to 10](https://youtu.be/aeyP8j4VhL8?t=479).
