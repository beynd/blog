...
After deciding on a focus area, which supports our business goal, we spend time coming up with ideas for experiments to run.

Everything we do is an experiment. We acknowledge up front that we don't know if it will work or not (even if sometimes we think we do), and design a controlled experiment to test. Everything is a hypothesis until we have data to back it up.

Coming up with ideas involves a semi-structured brainstorm session. We have a list of 19 main channels, which includes things like SEO, content marketing, offline events, and more.
...
A few ideas on our list which didn't make the cut (yet) include writing a book, and hosting a "how to make money during a pandemic" online workshop. These could work! But they are not our top ideas for now.
...
1. Which type of user do we think this will reach?
2. How effective do we think it will be?
3. How much investment (time or money) will it take?
...
- **Estimated reach:** Our best estimate at our many people we can reach through a certain channel. This may be easy to estimate (eg. number of Twitter followers) but sometimes we need to take our best guess. Accuracy is not the most important thing straight away, as you'll naturally start to learn more accurate numbers as you go.
- **Click through rate:** How many people have clicked through to our platform from the experiment. This happens in different ways eg. if it's a social media post, we can just measure clicks. If it's an offline event, then we need to do it differently. I'll explain in a moment.
- **Conversion rate:** How many people completed our desired action, such as join the waiting list or sign up.
...
*Follow us: Alex on Twitter, Shane on Twitter*
